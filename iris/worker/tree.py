...
def load_targets(
    ...
    """
    Returns a radix-tree that maps prefixes to a list of (protocol, ttls).
    ...
    >>> tree = load_targets(["8.8.8.0/24,1,10,20"], clamp_ttl_min=12, clamp_ttl_max=14)
    >>> tree["8.8.8.1"]
    [('1', range(12, 15))]
    >>> tree["8.8.4.0"]
    ...
    """
    tree: PyTricia[str, List[Tuple[str, range]]] = PyTricia(128)
